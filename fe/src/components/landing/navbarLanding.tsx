      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            <Link
              href="/register"
              className="rounded-lg bg-blue-600 px-5 py-2 text-sm font-semibold text-white hover:bg-blue-700 transition shadow-md shadow-blue-600/20"
            >
              Register
            </Link>
          </div>
        ...
        <div className="border-t border-slate-200 bg-white md:hidden">
          <div className="space-y-1 px-6 py-4">
            ...
            <div className="mt-4 flex flex-col gap-3 border-t border-slate-100 pt-4">
              <Link
                href="/login"
                className="text-center rounded-lg border border-slate-200 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50"
                onClick={() => setIsMenuOpen(false)}
              >
                Login
              </Link>
              <Link
                href="/register"
                className="text-center rounded-lg bg-blue-600 py-2.5 text-sm font-semibold text-white hover:bg-blue-700"
                onClick={() => setIsMenuOpen(false)}
              >
                Register
              </Link>
