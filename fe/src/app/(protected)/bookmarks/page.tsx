...
import { useBookmarks } from '@/hooks/queries/template.queries';
      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          ...
          <p className="text-slate-500">
            Simpan template favorit untuk akses cepat di satu tempat.
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border-2 border-dashed bg-slate-50 py-20 text-center">
          <p className="font-medium text-red-500">
            Gagal mengambil bookmark. Silakan muat ulang.
          </p>
        </div>
      ) : templates.length === 0 ? (
